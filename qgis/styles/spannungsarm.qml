...
<qgis version="1.9.0-Master" minimumScale="-4.65661e-10" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter=" &quot;status&quot;  = 1" symbol="0" label="spannungsarm"/>
      <rule filter=" &quot;status&quot;  > 1" symbol="1" label="nicht spannungsarm"/>
    </rules>
    <symbols>
      <symbol outputUnit="MM" alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="color" v="0,255,0,120"/>
  ...
  <edittypes>
    <edittype type="0" name="bemerkungen"/>
    <edittype type="0" name="gem_bfs"/>
    <edittype type="0" name="gemeinde"/>
    <edittype type="0" name="gemeinde_operat"/>
