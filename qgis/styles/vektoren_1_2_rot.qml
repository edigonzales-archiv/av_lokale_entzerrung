...
<qgis version="1.9.0-Master" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
    ...
    <symbols>
      <symbol outputUnit="MM" alpha="1" type="marker" name="0">
        <layer pass="0" class="VectorField" locked="0">
          ...
          <prop k="x_attribute" v="dy_avg"/>
          <prop k="y_attribute" v="dx_avg"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="round(&quot;fs_avg&quot;) || 'mm'"/>
  ...
  <edittypes>
    <edittype type="0" name="dx_avg"/>
    <edittype type="0" name="dy_avg"/>
    <edittype type="0" name="fs_avg"/>
    <edittype type="0" name="ogc_fid"/>
    <edittype type="0" name="operat_bfs"/>
    <edittype type="0" name="toleranzstufe"/>
  </edittypes>
